...
> Для использование необходимо наличие аккаунта. Рассмотрим возможности.  
...
> На основе обзора я выделил следующие положительные стороны:  
...
> Для себя я выделил следующие полезные возможности:  
> 1. Статистика.  
> 2. Определение приоритета для дела.  
> 3. Опция карма.  
